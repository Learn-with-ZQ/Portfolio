...
## `src/`
- `app/`: App Router pages, layout, global styles, metadata routes, and API endpoints
- `components/`: UI, layout, home sections, motion, project cards, testimonials, SEO helpers, and reusable primitives
- `data/`: source-of-truth content for profile, projects, skills, services, navigation, testimonials, and contact details
- `lib/`: authentication, formatting, SEO, metadata, schema, testimonial loading, and shared helpers
...
- `api/contact/`: server route for validating and forwarding contact form submissions
- `api/testimonials/`: Google-authenticated testimonial submission endpoint
- `api/auth/[...nextauth]/`: NextAuth route handler for Google sign-in
...
- `testimonials/`: testimonial cards and submission form
